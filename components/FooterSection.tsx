...
export function Footer() {
  return (
    <footer className="relative bg-[#050505] text-slate-300 overflow-hidden border-t border-red-950/50">
      {/* 🟢 Background Glow (হিরো সেকশনের মতো ছোট গ্লো) */}
      ...
      <div className="container mx-auto px-4 py-16 relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-red-500 shrink-0" /> Manikganj,
                Bangladesh
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-red-500 shrink-0" /> +880
                1XXX-XXXXXX
              </li>
              <li className="flex items-center gap-3">
          ...
          <div className="space-y-5">
            ...
            <Link
              href="/admin"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-red-950/30 border border-red-900/50 text-red-400 hover:bg-red-900/50 hover:text-white hover:border-red-500 transition-all text-sm font-bold group shadow-lg"
            >
            ...
            <div className="pt-4 flex items-center gap-3">
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-blue-600 hover:border-blue-500 transition-all hover:-translate-y-1 text-slate-400 hover:text-white shadow-sm"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-sky-500 hover:border-sky-500 transition-all hover:-translate-y-1 text-slate-400 hover:text-white shadow-sm"
              >
                <Twitter className="w-5 h-5" />
              </a>
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-slate-700 hover:border-slate-600 transition-all hover:-translate-y-1 text-slate-400 hover:text-white shadow-sm"
              >
        ...
        <div className="mt-16 pt-8 border-t border-slate-800/50 flex flex-col md:flex-row items-center justify-between gap-4 text-sm font-medium text-slate-500">
          ...
          <p className="flex items-center gap-1.5">
            ...
            by
            <a
              href="https://atulpaul.com" /* 🟢 এখানে আপনার পোর্টফোলিও ওয়েবসাইটের লিংক দিন */
              target="_blank"
